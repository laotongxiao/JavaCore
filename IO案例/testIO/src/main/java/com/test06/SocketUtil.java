...
public class SocketUtil {
    ...
    static {
        msgImp.put(DataProtocol.PROTOCOL_TYPE, "com.test06.DataProtocol");       //0
        msgImp.put(DataAckProtocol.PROTOCOL_TYPE, "com.test06.DataAckProtocol"); //1
        msgImp.put(PingProtocol.PROTOCOL_TYPE, "com.test06.PingProtocol");       //2
        msgImp.put(PingAckProtocol.PROTOCOL_TYPE, "com.test06.PingAckProtocol"); //3
    }
    /**
     * 读数据
     * 功能1服务器从客户端读取协议数据
