...
public class ClientHandler implements Runnable {
    ...
    public ClientHandler(ClientCallBack clientCallBack) {
        mHandler = new MyHandler(clientCallBack);
    }
...
//                mSocket.setSoTimeout(10);
    ...
    public class MyHandler extends Handler {
        ...
        public MyHandler(ClientCallBack callBack) {
    ...
    public class ReciveTask extends Thread {
        ...
        public void run() {
            while (!isCancle) {
                ...
                if (inputStream != null) {
                    BasicProtocol reciverData = SocketUtil.redFromStream(inputStream);
                    if (reciverData != null) {
